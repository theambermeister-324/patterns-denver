...
### Link to your work
```
https://github.com/theambermeister-324/patterns-denver/tree/main/.claude/skills/spec
```
...
**Note on the link:** the skill is on `main`, so anyone who clones the repo gets `/spec` — the link
above is live and permanent.
